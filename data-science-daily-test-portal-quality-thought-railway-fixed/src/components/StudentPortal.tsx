    ...
    try {
      ...
      if (res.ok) {
        ...
        if ((data.jobs || []).length === 0) {
          setLiveJobsError("No verified postings from the last 62 hours were found for this exact search. Try a different role, or widen your preferred location, and search again.");
        }
      } else {
                        ...
                        <div className="bg-emerald-950/30 border border-emerald-700/40 rounded-2xl p-4 space-y-3">
                          <div className="flex items-center justify-between gap-2">
                            <h5 className="text-xs font-extrabold text-emerald-300 uppercase tracking-wide font-mono flex items-center gap-1.5">
                              ...
                              Live Job Openings (Last 62 Hours){liveJobsFetchedFor ? ` — "${liveJobsFetchedFor}"` : ""}
                            </h5>
                            {liveJobs.length > 0 && (
                          ...
                          {loadingLiveJobs && (
                            <div className="text-xs text-emerald-200 italic py-4 text-center flex items-center justify-center gap-2">
                              ...
                              Searching LinkedIn, Naukri, Indeed, Glassdoor & 6+ more portals for postings from the last 62 hours...
                            </div>
                          )}
